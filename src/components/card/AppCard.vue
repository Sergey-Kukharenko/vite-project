  ...
  <div class="card">
    ...
    <div class="figcaption">
      ...
      <div class="group-form">
        ...
        <app-btn class="btn" cls="in-card" font-size="small" @click="addToCart(card)">Купить</app-btn>
      </div>
      <div class="controls">
        <div class="view">
        ...
        <div class="availability">
          <app-icon :name="card.availability.icon" />
          <div class="controls__label">{{ card.availability.label }}</div>
        </div>
      </div>
    </div>
  </div>
...
<style lang="scss" src="./AppCard.scss" scoped></style>
